...
class TranslationMetadata extends Equatable {
  ...
  bool get isFast => processingTime != null && processingTime!.inMilliseconds < 500;
...
class LanguageDetection extends Equatable {
  ...
  /// Get language name
  String get languageName => AppConstants.supportedLanguages[language] ?? language;
...
class QualityMetrics extends Equatable {
  ...
  static double calculateOverallScore({
    ...
    return (fluency * 0.3 + accuracy * 0.35 + naturalness * 0.2 + contextRelevance * 0.15);
  }
